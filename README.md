...
* Demo [Colab Notebook](https://github.com/chiayewken/keras-efficientnets/blob/master/Keras_EfficientNet_Demo.ipynb) showing how to apply EfficientNet to CIFAR10
